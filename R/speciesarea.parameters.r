  ...
  speciesarea.parameters = function( p=NULL ) {
    ...
    if (! exists("project.outdir.root", p)) p$project.outdir.root = project.datadirectory( "bio.indicators", p$project.name, "analysis" )  #required for interpolations and mapping
