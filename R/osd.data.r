  ...
  osd.data = function( source, osd.dir=file.path( project.datadirectory("bio.indicators"), "data", "osd" ), ... ) {
    ...
    if ( source %in% c("sable.meteorological", "sable.meteorological.refresh")) {
      ...
      outfile = file.path( project.datadirectory("bio.indicators"), "data", "osd", "sable.met.merged.rdata")  ## large file .. save a merged instance
