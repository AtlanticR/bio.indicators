...
indicators.map = function( ip=NULL, p=NULL, type="annual", vname=NULL, voi=NULL ) {
 ...
 # over-ride default dependent variable name if it exists
  ...
  if ( type %in% c("climatology" ) ) {
    ...
    H = indicators.db( p=p, DS="bottom.statistics.climatology" )
  ...
  if ( type %in% c("lbm.stats" ) ) {
    ...
    H = indicators.db( p=p, DS="lbm.stats" )
