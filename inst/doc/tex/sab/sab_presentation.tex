...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{\bd/{bio.temperature}/maps/SSE/bottom.predictions/global/{temperatures.bottom}.png}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \centering
    %  \includegraphics[width=0.75\textwidth]{\bd/{bio.indicators}/speciescomposition/analysis/SSE/allseasons/complex/maps/{maps.pca1.2010}.png}
