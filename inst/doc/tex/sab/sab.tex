...
%%% misc commands
\newcommand*{\D}{.} 
\newcommand{\biodata}{\string~/bio\D data}   %  \string~ is a representation of the home directory 
\newcommand{\mpa}{\biodata/bio\D indicators/mpa}  %  \string~ is a representation of the home directory 

\begin{document}

% \include{\mpa/sab/csas_coverpage.tex}
% \maketitle
...
\begin{figure}[h]
  ...
  \centering
  %\includegraphics[width=0.6\textwidth]{\mpa/maps/mpa_closeup.pdf}
  \includegraphics[width=0.6\textwidth]{\mpa/sab/SAB_MPA.pdf}
...
\begin{figure}[h]
  ...
  \label{fig:SAB}
  \centering
  \includegraphics[width=0.6\textwidth]{\mpa/maps/mpa.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/2.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/3.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/4.png}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/5.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/6.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/7.png}
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
      \includegraphics[width=0.45\textwidth]{\mpa/sab/8.png}
      \includegraphics[width=0.45\textwidth]{\mpa/sab/9.png}
  \end{tabular}
  \begin{tabular}{cc}
      \includegraphics[width=0.45\textwidth]{\mpa/sab/10.png}
      \includegraphics[width=0.45\textwidth]{\mpa/sab/11.png}
  \end{tabular}
...
\begin{figure}[ht]
  ...
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{\mpa/sab/12.jpg}
    \includegraphics[width=0.45\textwidth]{\mpa/sab/13.jpg}
  \end{tabular}
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{\mpa/sab/14.jpg}
    \includegraphics[width=0.45\textwidth]{\mpa/sab/15.jpg}
  \end{tabular}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/16.png}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/17.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/18.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/19.png}
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/20.jpg}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/21.jpg} 
  \end{tabular}
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/22.jpg}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/23.jpg}
  \end{tabular}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/24.png}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/25.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{\biodata/bio\D temperature/maps/SSE/bottom.predictions/global/{temperatures.bottom}.png}
...
\begin{itemize}
  ...
  \item Source code
      \begin{itemize}
        \item https://github.com/jae0/bio.groundfish/inst/scripts/groundfish.r
        \item https://github.com/jae0/bio.snowcrab/inst/scripts/1.snowcrab.r
      \end{itemize}
...
\begin{figure}[h]
  \centering
  	\begin{tabular}{cc}
      \includegraphics[width=0.5\textwidth]{\mpa/maps/{trawl.spatial.density}.pdf} &
      \includegraphics[width=0.5\textwidth]{{\mpa/sab/trawl.time.density}.pdf}
    \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{\mpa/sab/numberOfSets.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{\mpa/sab/toweddistance.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/{wing.v.door.byyear}.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{\mpa/sab/{wing.v.door}.pdf}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[width=0.5\textwidth]{\mpa/sab/{sa.comparison}.pdf} &
  \includegraphics[width=0.5\textwidth]{\mpa/sab/{sa.comparison.all}.pdf}
  \end{tabular}
...
%The extraction logic is captured in the script found at: \url{https://github.com/jae0/bio.indicators/R/get.marfis.data.R}
...
%\\url{https://github.com/jae0/bio.indicators/R/process.marfis.mpa.R} 
%\\url{https://github.com/jae0/bio.indicators/R/aggregate.marfis.R}
...
\begin{figure}[h]
	\centering
 \includegraphics[width=0.8\textwidth]{\mpa/sab/Rplot.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{\mpa/sab/Rplot01.png}
...
\begin{figure}[h]
  \centering
	\includegraphics[width=1.0\textwidth]{\mpa/sab/CCG_AIS.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{\mpa/sab/Line_of_Sight.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{\mpa/sab/Simard_Sight.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{\mpa/sab/Interpolation_Example1.pdf}
...
\begin{figure}[h]
	...
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{\mpa/sab/Counts_2013-2015_Q1.pdf} &
		\includegraphics[width=0.5\textwidth]{\mpa/sab/Counts_2013-2015_Q1_NNF.pdf}
	\end{tabular}
...
\begin{figure}[h]
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{\mpa/sab/Cost_2013-2015_Q1.pdf} &
		\includegraphics[width=0.5\textwidth]{\mpa/sab/Cost_2013-2015_Q1_NNF.pdf}
	\end{tabular}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.6\textwidth]{\biodata/bio\D snowcrab/R/gam/maps/{prediction.abundance.mean.R0.mass.2010}.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.6\textwidth]{\biodata/bio\D snowcrab/R/gam/maps/{prediction.habitat.mean.R0.mass.2010}.png}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{\biodata/bio\D snowcrab/assessments/2012/timeseries/interpolated/{snowcrab.habitat.sa}.png}
...
\begin{figure}[h]
  \centering
  %  \includegraphics[width=0.75\textwidth]{\biodata/bio\D indicators/speciescomposition/analysis/SSE/allseasons/complex/maps/{maps.pca1.2010}.png}
  \includegraphics[width=1.0\textwidth]{\biodata/bio\D indicators/oneoffs/ca.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{\biodata/bio\D indicators/oneoffs/{range.bathy}.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{\mpa/sab/26.png}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/27.png}
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/28.png}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/29.png} 
  \end{tabular}
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/30.png}
    \includegraphics[width=0.5\textwidth]{\mpa/sab/31.png}
  \end{tabular}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.8\textwidth]{\mpa/sab/32.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/33.png}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=1.0\textwidth]{\mpa/sab/34.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{\mpa/sab/matern.jpg}
